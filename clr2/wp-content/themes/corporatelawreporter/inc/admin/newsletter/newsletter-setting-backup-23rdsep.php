	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				...
				?>	
				<input type="text" class="regular-text" value="<?php echo $main_heading; ?>" id="main_heading" name="main_heading">
				</td>
			</tr>
			
			<tr>
				<th scope="row"><label for="headertext1">Header Text 1</label></th>
				<td>
				<?php 
				//initalize default value
			...
			<tr>
				<th scope="row"><label for="thanks_signature">Disclaimer </label></th>
				<td>
         	<?php
