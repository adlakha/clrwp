 ...
 */
?>
<div class="row custom-newsletter">
  <!--  ********************* Newsletter code ********************************** -->
    <?php
    ob_start();
    /*
...
-->				
  ...
  ?>
  <!--  ********************* Newsletter code End ********************************** -->  
  <!-- Create editor and insert themes -->
  <?php 
  $editor_id ="newsletter_code";
  wp_editor( $output, $editor_id );
  ?>
  <br/>
  <a href="<?php echo admin_url("admin.php?page=emindsNewsletter"); ?>" class="button newsletter-submit button-primary" >Back</a>
</div>