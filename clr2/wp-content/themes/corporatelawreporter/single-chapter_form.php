        ...
        <section class="col-sm-8 left-manageheight">
            <section class="posts-content">
						  ...
						  if(!empty($fileupload)){
						    ...
						    $downloadfile = $urlupload;	
							  ...
							  <div class="form-desc align-center">		 
								<h3><a target="_blank" href="<?php echo $downloadfile; ?>">Download Form <?php echo get_post_meta(get_the_ID(),'form_number_caform',TRUE); ?> </a> </h3>	 
                          	 	<!-- <a target="_blank" href="<?php echo $downloadfile; ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/<?php echo $icon_name; ?>" alt="image" /></a> -->
                          	 	</div>
                          	 	<?php } ?>
							<!--  Below the form description content  -->	 
                            <?php 
                ...
                <section class="about-author padding-none" >
                    ...
                    <section class="txtb">
                        <h4><a href="<?php echo $authorURL; ?>"><?php echo $authorName; ?> | <?php echo $designation; ?></a></h4>
                    ...
                    <section class="post-nav clearfix">
                        <ul>
                           <li><span>other article </span> <a href="<?php echo $authorURL; ?>"><?php echo $authorName; ?></a></li>
                           <li class="border-none" ><span> About <a href="<?php echo $authorURL; ?>"><?php echo $authorName; ?></a> </span></li>
                        </ul>
                    </section>
