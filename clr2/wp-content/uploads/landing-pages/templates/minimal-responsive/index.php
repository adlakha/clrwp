<?php
/**
 * Template Name:  Kirit Demo Template
...
<div class="wrapper">
  <div class="grids top">
    ...
    <div class="grid-10 grid hero-shot"> <?php echo $main_shot_hero_content;?> </div>
    <!--end of div grid-10--> 
  </div>
  <!--end of div grids--> 
...
<div class="grids">
<div class="grid-10 grid"> <?php echo $content;?> </div>
<!--end of grid-10-->
...
<div class="wrapper">
  <div id="footer">
    <div class="grids">
        <p class="footer-p"><?php echo $copy_right_text;?></p>     
    </div>
    <!--end of grids--> 
  </div>
  <!--end of footer--> 
